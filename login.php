...
<html lang="en">
  ...
  <body style="background: #ffffff url(images/back1.png) left bottom fixed;">
	...
	<nav class="navbar navbar-inverse navbar-static-top">
	  <div class="container">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" >Sistem Informasi Pengolahan Data Survei PPUP pada KKMC Rumbai</a>
		</div>
