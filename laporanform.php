...
?>
	...
	<div>
	  ...
	  <ul class="nav nav-tabs" role="tablist">
	    <li role="presentation" class="active"><a href="#rangking" aria-controls="rangking" role="tab" data-toggle="tab">Laporan Form Survei</a></li>
	    <li role="presentation" style="cursor: pointer;"><a id="cetak" role="tab">Cetak Laporan 1 (PrintMe)</a></li>
	    <li role="presentation"><a href="laporan-cetak_form.php" role="tab">Cetak Laporan 2 (FPDF)</a></li>
	  </ul>
	  ...
	  <div class="tab-content">
			...
			<table width="100%" class="table table-striped table-bordered">
		        <thead>
		            <tr>
						...
						<th rowspan="2" style="vertical-align: middle" class="text-center">Jenis Usaha</th>
						<th rowspan="2" style="vertical-align: middle" class="text-center">Pendapatan Usaha(/bulan)</th>
		...
		?>
		            <tr>
						...
						<th><?php echo $row1x['jenis_usaha'] ?></th>
						<th>Rp.<?php echo $row1x['p_usaha'] ?></th>
						<th><?php echo $row1x['keterangan'] ?></th>
