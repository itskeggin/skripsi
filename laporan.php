...
?>
	...
	<div>
	  ...
	  <ul class="nav nav-tabs" role="tablist">
	    <li role="presentation" class="active"><a href="#rangking" aria-controls="rangking" role="tab" data-toggle="tab">Laporan Survei</a></li>
	  ...
	  <div class="tab-content">
	    <div role="tabpanel" class="tab-pane active" id="rangking">
			...
			<table width="100%" class="table table-striped table-bordered">
		        <thead>
		            <tr>
		                <th rowspan="2" style="vertical-align: middle" class="text-center">ID Survei</th>
						<th rowspan="2" style="vertical-align: middle" class="text-center">Nama Peminjam</th>
						<th rowspan="2" style="vertical-align: middle" class="text-center">Tanggal Survei</th>
						<th rowspan="2" style="vertical-align: middle" class="text-center">Daerah Survei</th>
						<th rowspan="2" style="vertical-align: middle" class="text-center">Nama Surveyor</th>
		...
		?>
		            <tr>
		                <th><?php echo $row1x['id_survei'] ?></th>
						<th><?php echo $row1x['peminjam'] ?></th>
						<th><?php echo $row1x['tgl_survei'] ?></th>
						<th><?php echo $row1x['daerah_survei'] ?></th>
						<th><?php echo $row1x['nm_surveyor'] ?></th>
		                <?php
		                $ax= $row1x['id_laporan'];
						$stmtrx = $pro->readR($ax);
	  ...
	  <div class="tab-content">
	    <div role="tabpanel" class="tab-pane active1" id="rangking1">
	    	<br/>
